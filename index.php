...
<head>
    ...
    <script type="text/javascript">
        ...
        function writeToSelectedPrinter(){
            ...
            // window.alert(sid)
            while(x < no+1){
                var dataToWrite ='^XA^CF0,21^FO280,20^FDU54-Lung Cancer^FS^FO335,60^FD'+sid+'^FS^FO335,95^FD'+label_name+'^FS^FO335,130^FD'+label_date+'^FS^BY2,2,50^FO260,0^BQN,2,3^FDQAM'+sid+'^FS^XZ'
...
<body >
<span style="padding-right:50px; font-size:200%">U54 Lung Cancer Label Printing &nbsp;&nbsp;&nbsp;&nbsp; <button onclick="location.href = 'dashboard.php';" id="myHome">Go Back Home</button></span><br/>
...
<label for="fname">Study ID : </label>
